        ...
        (function (o, i) {
          ...
          function ye({
            ...
            return g({
              ...
              parsePrefix: (c) => {
                ...
                const x = c.parseIntermediateType(f.FUNCTION);
                if (e === void 0) J.parameters = Qt(x);
                else {
                  if (d && x.type === "JsdocTypeFunction" && x.arrow)
            ...
            return g({
              ...
              parseInfix: (c, d) => {
                ...
                if (
                  ...
                  v.consume(":");
                  let k;
                  d.type === "JsdocTypeStringValue" && (k = d.meta.quote);
                  ...
                  return (
                    c.acceptLexerState(v),
                    { type: "JsdocTypeJsdocObjectField", left: w(d), right: k }
                  );
                }
              },
            });
          ...
          function ge(e, t, r, s, c) {
            ...
            for (const T of d) {
              const J = e[T];
              if (J !== void 0)
                if (Array.isArray(J)) for (const x of J) ge(x, e, T, s, c);
                else ge(J, e, T, s, c);
            }
            c == null || c(e, t, r);
          }
...
var xn = l((n) => n.name === "literal", "isLiteral"),
  kn = l((n) => n.value.replace(/['|"]/g, ""), "toEnumOption"),
  On = l((n) => {
    switch (n.type) {
      case "function":
        ...
        return (
          (p = n.elements) != null && p.every((E) => E.name === "literal")
            ? (h = {
                ...
                name: "enum",
                value:
                  (u = n.elements) == null ? void 0 : u.map((E) => Ye(E.value)),
              })
            : (h = {
                ...i,
                name: a,
...
function tt({ fence: n = "```" } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let y of i)
      (Un.test(y.tokens.description) && !u
        ? p.push([y])
        : p[p.length - 1].push(y),
...
function st(n = "compact") {
  ...
  return (o) => {
    ...
    for (let [m, [h, E]] of p.entries())
      ((h.type = E),
        m > 0 &&
          ((h.type = h.postDelimiter.slice(y) + E),
          (h.postDelimiter = h.postDelimiter.slice(0, y))),
        ([h.postType, h.description] = j(h.description.slice(E.length))),
        u.push(h.type));
    return (
      (u[0] = u[0].slice(1)),
...
l(it, "getJoiner");
var Dn = l((n) => n && n.startsWith('"') && n.endsWith('"'), "isQuoted");
function lt() {
...
var F = Je.stringifyRules(),
  Cn = F.JsdocTypeObject;
F.JsdocTypeAny = () => "any";
F.JsdocTypeObject = (n, a) => `(${Cn(n, a)})`;
...
l(bt, "isTooLongForDefaultValueSummary");
function b(n, a) {
...
function Et(n, a) {
  if (n != null) {
    let { value: o } = n;
    if (!ae(o)) return bt(o) ? b(a == null ? void 0 : a.name, o) : b(o);
  }
  return null;
}
l(Et, "createDefaultValue");
function ke({ name: n, value: a, elements: o, raw: i }) {
  return a ?? (o != null ? o.map(ke).join(" | ") : (i ?? n));
}
l(ke, "generateUnionElement");
...
function St({ type: n, raw: a }) {
  return a != null ? (xe(a) ? b(n, a) : b(a)) : b(n);
}
...
function Lt(n, a) {
  if (n != null) {
    let { value: o } = n;
    if (!ae(o)) return _t(n) && Ft(a) ? b(JSON.stringify(o)) : b(o);
  }
  return null;
}
...
var Wn = l((n, a, o) => {
  ...
  ar = l((n, a) => {
    let o = We(n, a);
    return Ge(o) ? (Array.isArray(o) ? zn(o) : Zn(o)) : [];
...
l(er, "extractComponentDescription");
...
export { we as b, or as c, rr as g, er as n, ar as o, sr as y, Ne as z };
