...
var j = (r, t) => {
  ...
  I = async (r, t) => {
    globalThis &&
      ...
      (await Promise.all(
        [...globalThis.PLUGINS_SETUP_FUNCTIONS].map((e) => e(r, t)),
      ));
  },
  f = new Map();
async function N(
  ...
  let { argTypes: e } = t,
    i = Object.entries(r)
      .filter(([n]) => {
        var a, s;
        return (
          ((s = (a = e[n]) == null ? void 0 : a.table) == null
            ? void 0
            : s.category) === "slots"
        );
      })
    ...
    (e, i) => (n) => {
      let a,
        s = i((o) => {
          let u = U(o);
          return (
            o && (u.args = Object.assign(n.args, u.args)),
            (a = e({ ...n, ...u })),
            a
          );
        }, n);
