...
const FLAG_VARIANTS: Record<snackBarVariant, {style:{card:string, icon:string, title:string, description:string}, icon:string}> = {
  informative: {
    style: {
      ...
      >
        ...
        >
          ...
          <div class="flex flex-col justify-start w-full h-full text-base leading-normal">
            ...
            <span
              :class="cn('font-normal',flagVariant.style.description)"
            >
